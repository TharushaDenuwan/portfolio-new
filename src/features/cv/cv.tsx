    ...
    <section className="bg-blue-100 relative">
      ...
      <div className="flex items-center justify-between ">
        ...
        <div className="flex gap-3">
          ...
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-full font-medium text-sm transition-all duration-300 bg-gray-600 hover:bg-gray-700 text-white hover:shadow-lg hover:scale-105"
          >
            <svg
              className="w-4 h-4"
              fill="none"
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between text-xs text-gray-500">
          <span>PDF Format • Updated Recently • View online or download</span>
          <span>~250KB</span>
        </div>
      </div>
        </div>
