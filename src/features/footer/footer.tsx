      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <Link
              href="/"
              className="inline-flex items-baseline space-x-1 mb-4"
            >
              <span className="text-4xl font-extrabold leading-none text-blue-400">Port</span>
              <span className="text-lg font-medium text-white">folio</span>
            </Link>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-sm text-gray-400 mb-4 md:mb-0">
              © {currentYear} Tharusha Denuwan. All rights reserved.
            </div>
        ...
        <div className="text-center mt-8">
          <button
            ...
            className="inline-flex items-center space-x-2 text-gray-400 hover:text-blue-400 transition-colors duration-300 group"
          >
            <svg 
